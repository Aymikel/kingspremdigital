        ...
        <div className="divide-y divide-foreground/10 border-y border-foreground/10">
          {FAQS.map((f) => (
            <details key={f.q} className="group py-6">
              <summary className="flex cursor-pointer items-start justify-between gap-6 font-display text-2xl uppercase leading-tight list-none">
                {f.q}
                <span className="mt-1 font-mono text-accent group-open:rotate-45 transition-transform">
                  +
                </span>
              </summary>
