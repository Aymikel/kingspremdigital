        ...
        <div className="mb-16 grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <form
              ...
              className="mt-8 flex max-w-sm gap-0 border-b border-white/20 pb-1"
            >
              <input
                type="email"
                placeholder="Your email"
                className="flex-1 bg-transparent py-2 text-sm placeholder:text-white/30 focus:outline-none"
                required
              />
